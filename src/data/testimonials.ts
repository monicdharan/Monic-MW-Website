...
export const whatsappReviews: ReviewScreenshot[] = [
  {
    ...
    caption: "Thesis editing, plagiarism check, and prompt delivery.",
    type: "whatsapp",
  },
  {
    ...
    caption: "Appreciation for writing quality and quick turnaround.",
    type: "whatsapp",
  },
  {
    ...
    caption: "Departmental presentation & hard copy thesis formatting.",
    type: "whatsapp",
  },
];
